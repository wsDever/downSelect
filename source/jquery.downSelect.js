    ...
    multiChoose: function multiChoose(event) {
      ...
      if (hasSelected) {
        if(value == 'disall'){
          ...
          $target.removeClass('dropdown-chose').attr("data-value","all").html("全选");
          $.each(allli,function(){
          ...
          var selAllEl = $target.parent().children(".dropdown-option[data-value='disall']");
          selAllEl.removeClass('dropdown-chose').attr("data-value","all").html("全选");
